...
copyright:
  creation: reprint
  license: CC-BY-4.0
  source: https://www.cnblogs.com/tocy/p/media_container_4-mkv.html
  author:
    name: 'Tocy e-mail: zyvj@qq.com'
    url: https://home.cnblogs.com/u/tocy/
createTime: 2025/12/18 02:12:34
permalink: /develop_notes/9qg96k0b/
---
...
- **VINT_MARKER**：二进制数据中第一个 `1` 的位置。
- **VINT_WIDTH**：在 `VINT_MARKER` 之前的 `0` 的个数，`VINT_WIDTH + 1` 表示 vint 占用的字节数。
...
- **哪里可以找到该容器格式最标准的文档资料？**
  > Matroska 是开源的，可以通过 [https://www.matroska.org/](https://www.matroska.org/) 直接访问其标准文档。

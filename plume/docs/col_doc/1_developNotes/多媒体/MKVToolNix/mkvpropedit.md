...
copyright:
  creation: translate
  license: CC-BY-4.0
  source: https://mkvtoolnix.download/doc/mkvpropedit.html
  author:
    name: mkvtoolnix
    url: https://mkvtoolnix.download/
createTime: 2025/12/20 02:59:19
permalink: /develop_notes/kci6f5co/
---
...
段信息可以使用以下三个词之一选择：'info'、'segment_info' 或 'segmentinfo'。它包含段标题或段 UID 等属性。
...
mkvpropedit(1) 使用确定系统区域设置的默认变量（例如 LANG 和 LC_* 系列）。
